    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding" class = "card animate__animated animate__fadeInUp">
                    <?php
                    foreach ($product_list as $value) {
						...
						<div  class="product_item" class = "card animate__animated animate__fadeInUp" >
